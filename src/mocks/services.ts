...
export const serviceDetails: ServiceDetail[] = [
  ...
  },
  {
    ...
    seoTitle: "Drones para inmobiliarias y real estate | AVANZA DRONE",
    seoDescription:
      "Fotografía y vídeo aéreo con drones para inmobiliarias en España: viviendas premium, promociones, terrenos y hoteles. Vende más rápido con imágenes impactantes.",
    seoKeywords:
    ...
    heroImage:
      "https://readdy.ai/api/search-image?query=Aerial%20drone%20view%20of%20a%20luxury%20modern%20villa%20with%20pool%20at%20twilight%2C%20warm%20interior%20lights%20glowing%2C%20dark%20moody%20atmosphere%2C%20teal%20shadows%2C%20high%20detail%2C%20professional%20real%20estate%20photography%2C%20dramatic%20lighting&width=1600&height=900&seq=svc-realestate-hero&orientation=landscape",
    intro: [
      "La fotografía y el vídeo aéreo transforman la presentación de una propiedad. Mostramos viviendas premium, promociones, terrenos, hoteles y naves industriales desde perspectivas que generan deseo y aceleran la venta o el alquiler.",
      "Trabajamos para inmobiliarias, promotoras y propietarios que quieren destacar sus activos con imágenes de alto impacto para portales, campañas y presentaciones.",
    ],
    problems: [
      "Mostrar el entorno y la ubicación de la propiedad",
      "Destacar grandes superficies y fincas desde el aire",
      "Crear contenido que diferencie el anuncio inmobiliario",
      "Promocionar promociones y complejos completos",
    ],
    deliverables: [
      "Fotografía aérea profesional",
      "Vídeo inmobiliario editado",
      "Clips para portales y redes",
      "Imágenes para campañas de marketing",
    ],
    process: [
